...
const SearchView = ({ navigation }) => {
    ...
    const searchResults = [
        { title: 'I love my wife', service: 'Spotify', image: require('./images/chance.png'), mediaId: "Song1", youtubeId: "TQcGnEhciNY" },
        { title: 'Friends', service: 'Netflix', image: require('./images/fronds.png'), mediaId: 'Netflix1', youtubeId: "Kl7WUJRyyEk" },
        { title: 'Vine compilation', service: 'Youtube', image: require('./images/youtube.jpg'), mediaId: 'Youtube1', youtubeId: "eVrYbKBrI7o" },
        { title: 'Jackbox', service: 'Steam', image: require('./images/steam1.jpg'), mediaId: 'jackbox', youtubeId: "yhW8PfKB828" },
        { title: 'overcooked', service: 'Steam', image: require('./images/steam2.png'), mediaId: 'overcooked', youtubeId: "0n1x-zd7gZM" },
        { title: 'Peppa Pig', service: 'Netflix', image: require('./images/netflix1.png'), mediaId: 'Song3', youtubeId: "YU3eDa8ehzc" },
    ]
